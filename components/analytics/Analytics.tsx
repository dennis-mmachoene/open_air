...
/**
 * Product analytics via PostHog, loaded from their CDN (no npm dependency).
 * No-op unless NEXT_PUBLIC_POSTHOG_KEY is set. For Vercel Web Analytics / Speed
 * Insights, add <Analytics/> and <SpeedInsights/> from @vercel/* at deploy time.
 */
