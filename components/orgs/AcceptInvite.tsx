...
export function AcceptInvite({ token }: { token: string }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <button type="button" onClick={accept} disabled={busy} className="rounded-full bg-text px-5 py-2.5 text-sm font-medium text-canvas hover:opacity-90 disabled:opacity-50">
