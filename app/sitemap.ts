...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ["", "/gallery", "/c", "/trends", "/studio", "/studio/ai", "/studio/scales", "/studio/tokens", "/studio/stress", "/studio/output", "/studio/dataviz", "/studio/gradient-check", "/studio/elevation", "/studio/viz-repair", "/pricing", "/about", "/legal"].map(
